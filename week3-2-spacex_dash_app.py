...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
    	                        ...
    	                        dcc.RangeSlider(id='payload-slider',
                                        ...
                                        marks={i: f'{i}' for i in range(0, 10001, 2000)},  # Optional: add marks for clarity
...
def update_success_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Use all rows in the dataframe to render the pie chart for total success launches
...
# TASK 4: Callback function to render the scatter plot based on site and payload range
@app.callback(
